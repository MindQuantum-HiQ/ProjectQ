...
from .._core import BasicMapperEngine
...
class IBM5QubitMapper(BasicMapperEngine):
    ...
    def is_available(self, cmd):
        ...
        from projectq.backends import (  # pylint: disable=import-outside-toplevel
            IBMBackend,
        )
    ...
    def _determine_cost(self, mapping):
        ...
        """
        cost = 0
        for tpl, interaction_cost in self._interactions.items():
            ctrl_id = tpl[0]
            target_id = tpl[1]
