...
if(NOT pybind11_FOUND)
  ...
  if(NOT _is_virtualenv)
    ...
    if(NOT pybind11_FOUND)
      ...
      message(STATUS "Looking for pybind11-cmake")
      # If everything else fails, rely on the pybind11_cmake package
      find_python_module(pybind11-cmake REQUIRED)
      execute_process(
        COMMAND ${Python_EXECUTABLE} -c "import pybind11_cmake; print(pybind11_cmake.__path__[0])"
        OUTPUT_VARIABLE pybind11_DIR
        OUTPUT_STRIP_TRAILING_WHITESPACE)
...
# pybind11 < 2.6.0 located in either user or global sites but we also make use of the REQUIRED argument to ensure that
# all paths through this CMake file lead to at least one fatal failure point if no pybind11 can be found
...
find_package(pybind11 2.6.0 CONFIG REQUIRED NO_DEFAULT_PATH)
