...
# Check whether the NVCXX compiler supports a given flag.
#
# nvcxx_check_compiler_flag(<lang> <flag> <var>)
#
# Same functionality as the builtin CMake check_compiler_flag but only for the NVCXX compiler
function(nvcxx_check_compiler_flag _flag _var)
  ...
  if(NOT DEFINED "${_var}")
    ...
    separate_arguments(CMAKE_REQUIRED_FLAGS)

    execute_process(
      COMMAND ${_NVCXX_NVCC_EXECUTABLE} -c -D${_var} ${_flag} ${CMAKE_REQUIRED_FLAGS}
